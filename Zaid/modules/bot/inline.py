...
<b> • Broken :</b> {message.from_user.mention}
...
"""
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://te.legra.ph/file/e9107492c031cfa653f0e.jpg",
            input_message_content=InputTextMessageContent(
                msg, parse_mode=ParseMode.HTML, disable_web_page_preview=True
            ),
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 ʙʀᴏᴋᴇɴ ᴜsᴇʀʙᴏᴛ 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
